...
# Locale settings
export LANG="en_CA.UTF8" # Sets default locale for all categories
export LC_ALL="en_CA.UTF8" # Overrides all other locale settings
export LC_CTYPE="en_CA.UTF8" # Controls character classification and case conversion
